...
import pl.jasiek.app.controller.AddVehicleCommand;
...
import pl.jasiek.app.repository.csv.VehicleCsvRepo;
...
public class Config {
    ...
    private Repository vehicleCsvRepo = new VehicleCsvRepo();
...
//        commandList.add(new ShowAllClientsCommand(clientMemoryRepo, view));
        commandList.add(new AddVehicleCommand(view, vehicleCsvRepo));
